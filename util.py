...
# gets last tag of fakehttp
def get_last_fakehttp_tag() -> str:
    last_fakehttp_tag = get_last_github_tag('MikeWang000000/FakeHTTP')
    print(f"Last fakehttp tag: {last_fakehttp_tag}")
    return last_fakehttp_tag
